...

                {
                    ...
                    children: [
                        ...
                        },
                        {
                            ...
                            loadChildren: () =>
                                import(
                                    './presentations/admin/facilitator/admin-facilitator.routing.modules'
                        ...
                        },
                        {
                            ...
                            loadChildren: () =>
                                import(
                                    './presentations/admin/vendor/admin-vendor-routing.module'
                                ).then((m) => m.AdminVendorRoutingModule),
                        },
                        {
                            path: 'reports',
                            loadChildren: () =>
                                import(
                                    './presentations/admin/reports/admin-report-routing.module'
                                ).then((m) => m.AdminReportRoutingModule),
                        },
                        {
...

                {
                    ...
                    children: [
                        ...
                        },
                        {
                            ...
                            loadChildren: () =>
                                import(
                                    './presentations/owner/lease/owner-lease.routing.modules'
                                ).then((m) => m.OwnerLeaseRoutingModule),
                        },
                        {
                            path: 'payments',
                            loadChildren: () =>
                                import(
                                    './presentations/owner/payments/owner-payments.routing.modules'
                                ).then((m) => m.OwnerPaymentsRoutingModule),
                        },
                        {
                            path: 'devices',
                            loadChildren: () =>
                                import(
                                    './presentations/owner/devices/devices.routing.modules'
                                ).then((m) => m.DevicesRoutingModule),
                        }
                    ],
                },
            ],
