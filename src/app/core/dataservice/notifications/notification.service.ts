...
export class NotificationService {
    ...
    GetAllNotificationTypes(): Observable<NotificationTypeDTO[]> {
        return this.http.get<NotificationTypeDTO[]>(
            `${this.apiUrl}/notification-type`
        );
    }
    GetAllNotificationChannels(): Observable<NotificationChannelDTO[]> {
        return this.http.get<NotificationChannelDTO[]>(
            `${this.apiUrl}/notification-channel`
        );
    }
    GetAllNotificationPreferencesByUser(
        userId: number
    ): Observable<NotificationPreferenceDTO[]> {
        return this.http.get<NotificationPreferenceDTO[]>(
            `${this.apiUrl}/notification-preference/by/user/${userId}`
        );
    }
}
