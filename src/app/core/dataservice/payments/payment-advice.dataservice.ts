...
export class PaymentAdviceDataService {
    ...
    GetPenaltySettings(userId: number) {
        return this.http.get<PenaltySettingDTO>(
            `${this.apiUrl}/user/penalty-setting/${userId}`,
        );
    }

    GetDueAmountForMonthOwner() {
        return this.http.get<number>(
            `${this.apiUrl}/payment-advice/owner/monthly-due`,
        );
    }
    ...
    RevertWriteOffPenalty(data: WriteOffPenaltyDTO) {
        return this.http.post(
            `${this.apiUrl}/payment-advice/revert-write-off-penalty`,
            data
        );
    }
    ...
    GetPenaltyByPaymentAdviceWithDate(
        paymentAdviceId: number,
        date: Date

    ): Observable<PenaltyDetailsDTO> {
        return this.http.post<PenaltyDetailsDTO>(
            `${this.apiUrl}/payment-advice/penalty-date`, {
    ...
    GetAllPaymentAdviceByActiveBuildingUnitLeaseUnderOwnerByMonthYear(buildingId: number, year: number, month: number): Observable<UnitDTO[]> {
        return this.http.get<UnitDTO[]>(
            `${this.apiUrl}/lease-agreement/payment-status/unit/monthly/owner/${buildingId}/${year}/${month}`
        );
    }
