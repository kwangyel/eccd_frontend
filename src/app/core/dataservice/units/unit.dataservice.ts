...
export class UnitDataService {
    ...
    GetAllUnitsByBuildingAndOwner(buildingId: number,params?: PaginatedParamsOptions): Observable<PaginatedData<UnitDTO>> {
        ...
        return this.http.get<PaginatedData<UnitDTO>>(
            `${this.apiUrl}/unit/owner/building/${buildingId}`,
            { params: httpParams }
        );
    }
