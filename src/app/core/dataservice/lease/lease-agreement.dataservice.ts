...
export class LeaseAgreementDataService {
    ...
    GetAllActiveUnitLeaseByOwner(): Observable<PaginatedData<LeaseAgreeementDTO>> {
        return this.http.get<PaginatedData<LeaseAgreeementDTO>>(
            `${this.apiUrl}/lease-agreement/owner/unit/active/p`
        );
    }

    GetAllExpiringUnitLeaseByOwner(): Observable<PaginatedData<LeaseAgreeementDTO>> {
        return this.http.get<PaginatedData<LeaseAgreeementDTO>>(
            `${this.apiUrl}/lease-agreement/owner/unit/upcoming-expiration/p`
        );
    }
    ...
    TerminateLeaseAgreement( data: LeaseModificationDTO): Observable<LeaseAgreeementDTO> {
        return this.http.post<LeaseAgreeementDTO>(
            `${this.apiUrl}/lease-agreement/terminate/owner`,
            data
        );
