...
import { LEASEATTACHMENTTYPES, LEASESTATUS, LEASETYPE, LESSEETYPE, LESSORTYPE, NOTIFICATIONTYPES } from 'src/app/core/constants/enums';
...
import { LeaseAgreeementDTO, LeaseAgreementAttachmentDTO } from 'src/app/core/dataservice/lease/lease-agreement.dto';
...
import { AdminLeaseCreateEntryDamageItemModalComponent } from 'src/app/presentations/admin/lease/components/admin-lease-create-entry-damage-item-modal/admin-lease-create-entry-damage-item-modal.component';
import { AdminLeaseNotificationsComponent } from 'src/app/presentations/admin/lease/components/admin-lease-notifications/admin-lease-notifications.component';
import { AdminLeasePaymentsComponent } from 'src/app/presentations/admin/lease/components/admin-lease-payments/admin-lease-payments.component';
import { AdminLeaseResolveDamageItemModalComponent } from 'src/app/presentations/admin/lease/components/admin-lease-resolve-damage-item-modal/admin-lease-resolve-damage-item-modal.component';
import { DamageItemChatBoxComponent } from 'src/app/presentations/admin/lease/components/damage-item-chat-box/damage-item-chat-box.component';
...
@Component({
  selector: 'app-view-detailed-lease',
  standalone: true,
  ...
  templateUrl: './view-detailed-lease.component.html',
  styleUrl: './view-detailed-lease.component.scss'
})
export class ViewDetailedLeaseComponent {
