...
@Component({
  selector: 'app-tax-report-building-list',
  standalone: true,
  imports: [
    CommonModule,
    TableModule,
  ...
  templateUrl: './tax-report-building-list.component.html',
  styleUrl: './tax-report-building-list.component.scss'
})
export class TaxReportBuildingListComponent implements OnInit {
  ...
  navigateToBuilding(buildingId: string) {
    this.router.navigate([
      `owner/payments/tax-reports/${buildingId}`,
    ]);
  }
