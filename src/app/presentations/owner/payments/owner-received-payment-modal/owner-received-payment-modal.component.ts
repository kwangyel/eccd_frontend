...
@Component({
  selector: 'app-owner-received-payment-modal',
  standalone: true,
  imports: [
    DropdownModule,
    InputNumberModule,
  ...
  templateUrl: './owner-received-payment-modal.component.html',
  styleUrl: './owner-received-payment-modal.component.scss'
})
export class OwnerReceivedPaymentModalComponent implements OnInit {
  ...
  constructor(
    ...
    console.log("User ID for penalty settings:", this.authService.GetAuthenticatedUser());
    this.paymentAdviceDataService.GetPenaltySettings(userId).subscribe((res) => {
    ...
    this.paymentAdviceDataService.GetAllPendingAdvicesByTenantAndLease(
