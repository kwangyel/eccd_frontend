...
import { PaymentAdviceDto, PaymentAdviceSummaryDTO } from 'src/app/core/dto/payments/payment-advice.dto';
import { PaymentReceiptDTO } from 'src/app/core/dto/payments/payment-receipt-dto';
import { UnitDTO } from 'src/app/core/dto/units/unit.dto';
import { AdminLeaseTerminateLeaseComponent } from 'src/app/presentations/admin/lease/components/admin-lease-terminate-lease/admin-lease-terminate-lease.component';
import { AdminReviseLeaseComponent } from 'src/app/presentations/admin/lease/components/admin-revise-lease/admin-revise-lease.component';
import { AdminBuildingGenerateMonthlyPaymentAdvicesComponent } from 'src/app/presentations/admin/transactions/building/components/admin-building-generate-monthly-payment-advices/admin-building-generate-monthly-payment-advices.component';
...
import { AdminUsersUpdateModalComponent } from 'src/app/presentations/admin/users/components/admin-users-update-modal/admin-users-update-modal.component';
import { TerminateLeaseComponentComponent } from '../../lease/terminate-lease-component/terminate-lease-component.component';
import { OwnerViewPaymentAdviceComponent } from '../owner-view-payment-advice/owner-view-payment-advice.component';
...
@Component({
  selector: 'app-owner-list-payment-advice',
  standalone: true,
  imports: [
    CommonModule,
    DividerModule,
  ...
  templateUrl: './owner-list-payment-advice.component.html',
  providers: [DialogService],
  styleUrl: './owner-list-payment-advice.component.scss'
})
export class OwnerListPaymentAdviceComponent implements OnInit {
  buildingId: number;
  ...
  loadData() {
    ...
    this.paymentDataService
      .GetAllPaymentAdviceByActiveBuildingUnitLeaseUnderOwnerByMonthYear(
        this.buildingId,
